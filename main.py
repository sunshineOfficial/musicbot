...
class MusicBot(commands.Cog):
    ...
    async def help(self, ctx):
        await ctx.send('''Вот что я умею:
+play <название видео или ссылка> - включить музыку с ютуба
+leave - выйти из голосового чата
+stop - выключить плеер
+pause - поставить музыку на паузу
+resume - снять музыку с паузы
+skip - пропустить играющую музыку и включить следующую в очереди
+queue - показать очередь треков
+cat - показать случайного кота
+dog - показать случайную собаку
+numerals <слово> <число> - согласовать слово с числом
+alive <слово> - определить, живое ли существительное или нет
+noun <слово> - изменить существительное в соответствии с введенным падежом и числом
+inf <слово> - вывести слово в начальной форме
+morph <слово> - произвести морфологический анализ слова
+roll_dice <количество кубиков> - бросить кости
+ban <тэг пользователя> <причина (необязательно)> - забанить пользователя (если у вас есть права на это)
+kick <тэг пользователя> <причина (необязательно)> - кикнуть пользователя (если у вас есть права на это)
+heads_or_tails - орёл или решка
+clear <число сообщений> - чистка сообщений в чате
+change_prefix <префикс> - сменить префикс бота
+map <место> - показать место на карте
+satellite <место> - показать место на спутнике
+quote - отправить случайную цитату
+city <город> - игра в города
+region <город или номер региона> - отправить номер региона города или все города с этим номером региона
+restart_city - начать игру в города заново
+add_fav <название видео или ссылка> - добавить музыку в избранное
+my_fav - показать плейлист избранной музыки
+play_fav - включить плейлист избранной музыки
+delete_fav <номер музыки в плейлисте> - удалить музыку из плейлиста''')
